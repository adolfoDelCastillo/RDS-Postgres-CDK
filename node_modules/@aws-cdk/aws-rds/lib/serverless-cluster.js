...
class ServerlessCluster extends ServerlessClusterNew {
    constructor(scope, id, props) {
        ...
        const cluster = new rds_generated_1.CfnDBCluster(this, 'Resource', {
            ...
            masterUserPassword: (_c = credentials.password) === null || _c === void 0 ? void 0 : _c.unsafeUnwrap(),
...
ServerlessCluster[_a] = { fqn: "@aws-cdk/aws-rds.ServerlessCluster", version: "1.155.0" };
/**
...
class ServerlessClusterFromSnapshot extends ServerlessClusterNew {
    constructor(scope, id, props) {
        ...
        const cluster = new rds_generated_1.CfnDBCluster(this, 'Resource', {
            ...
            masterUserPassword: (_d = (_c = secret === null || secret === void 0 ? void 0 : secret.secretValueFromJson('password')) === null || _c === void 0 ? void 0 : _c.unsafeUnwrap()) !== null && _d !== void 0 ? _d : (_e = credentials === null || credentials === void 0 ? void 0 : credentials.password) === null || _e === void 0 ? void 0 : _e.unsafeUnwrap(),
        });
        this.clusterIdentifier = cluster.ref;
        // create a number token that represents the port of the cluster
        const portAttribute = core_1.Token.asNumber(cluster.attrEndpointPort);
